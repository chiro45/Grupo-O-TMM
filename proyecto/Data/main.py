...
from .Estados import menu_principal,pantalla_carga,nivel1
...
def main():
    ...
    estado_diccionaro = {c.MENU_PRINCIPAL: menu_principal.Menu(),
                  c.PANTALLA_DE_CARGA: pantalla_carga.PantallaDeCarga(),
                  c.TIEMPO_TERMINADO: pantalla_carga.TiempoTerminado(),
                  c.JUEGO_TERMINADO: pantalla_carga.JuegoTerminado(),
